...
function getAdminApp(): App {
  ...
  try {
    ...
    // A truncated paste, a stray quote/newline from Vercel's env var UI, or
    // (most common) pasting the service account JSON pretty-printed across
    // multiple lines instead of collapsed to one line is the usual cause —
    // this is deliberately more specific than a generic "invalid credential"
    // error, since the fix is almost always "re-paste the full service
