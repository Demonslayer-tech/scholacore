# ScholaCore v2 — Firestore Schema
...
| aiQueryCount | number | resets daily; mirrors `ai_usage/{uid}_{yyyy-mm-dd}` |
| createdAt | timestamp | |
...
| fullName | string | |
| email | string | |
| credentialsSummary | string | free text |
...
| count | number | incremented in a Firestore transaction, capped at 30 |
